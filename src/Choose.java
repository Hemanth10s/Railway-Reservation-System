...
public class Choose extends javax.swing.JFrame {
    ...
    public Choose(String user,String password,String name,String age,String class_selected,String seat_number) {
        initComponents();
        this.user=user;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Search_train setr = new Search_train(user,password);
        dispose();
        setr.setVisible(true);// TODO add your handling code here:
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
    Book_history book = new Book_history(name,age,class_selected,seat_number);
    dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Choose(null,null,null,null,null,null).setVisible(true);
            }
        });
    }
